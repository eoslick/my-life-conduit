...
/**
 * Event indicating that the UserGoals aggregate has been initialized for a user.
 */
public record UserGoalsInitialized( // <<< RENAMED RECORD >>>
                                    UUID eventId,
