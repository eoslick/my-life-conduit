...
/**
 * Event indicating a goal was unmarked as a priority.
 */
public record PriorityGoalDeselected(
        UUID eventId,
        UserId aggregateId,
        TenantId tenantId,
